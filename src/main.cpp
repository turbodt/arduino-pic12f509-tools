...
#include "coding-generation/main.hpp"
#include "serial.cpp"
#include "compile.cpp"
...
int main(int argc, char * argv[]) {
  ...
  if (argc < 2) {
    std::cerr << "Required one of the following commands:\n"
      << "compile, decompile, coding-generation, upload"
      << std::endl;
    return 1;
  }
  ...
  } else if (argv[1] == std::string("coding-generation")) {
    return coding_generation::main(argc-1, &argv[1]);
